...
tags: [stageB, notes, qa, test, process, quality_management, unit_testing, test_planning, prevention, quality_assurance, quality_metrics, code_review]
draft: false
---
...
- Artigo de Referência usado para idealizar as imagens:
	- AMANN, Sven; JÜRGENS, Elmar. **Change-Driven Testing**. In: THE FUTURE OF SOFTWARE QUALITY ASSURANCE. 2020. p. 1-14. https://doi.org/10.1007/978-3-030-29509-7_1
		- A forma de diagramar a presença de erros e cobertura de testes em um sistema foi adaptada em uma nova imagem para demonstrar a diferença entre o cenário de desenvolvimento com e sem cobertura de testes.
