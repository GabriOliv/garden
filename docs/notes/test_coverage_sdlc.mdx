...
<figure>
  <figcaption class="text--center">
    Iteração de desenvolvimento sem cobertura de testes[^1]
  </figcaption>
...
2. Processo de Desenvolvimento:
   - Desenvolvedor:
     ...
     - <span style={{ color: "var(--ifm-color-danger-darker)" }}>
...
<figure>
  <figcaption class="text--center">
    Iteração de desenvolvimento com cobertura de testes[^2]
  </figcaption>
...
- 🎯 Cobertura de Testes
  - 📊 Entendimento - **Por que Importa?** - Reduz regressões 70% - Facilita refatoração - Documenta comportamento
  - 🔄 Comparação SDLC
    - 🔴 **SEM Cobertura**
      - Testes manuais
      - Bugs não rastreados
  ...
  - ⚠️ Armadilhas - **Falsa Cobertura** - Priorize qualidade sobre quantidade
  - 📋 Implementação
    1. 🔍 Diagnóstico
    2. 🎯 Priorização
    3. 🔄 Iteração
...
- Artigos:
  - AMANN, Sven; JÜRGENS, Elmar. Change-Driven Testing. In: _THE FUTURE OF SOFTWARE QUALITY ASSURANCE_. 2020. p. 1-14.
