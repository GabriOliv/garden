...
flowchart LR
	...
	subgraph c["Github Action (deploy.yml)"]
		...
		c2["Build"] -->
		c3["Deploy"] -->
		c4["Merge Files<br>(main -> gh-pages)"]
	end
```
...
- A licença do projeto pode ser encontrada no [Repositório do Projeto](https://github.com/GabriOliv/garden/blob/main/LICENSE);
