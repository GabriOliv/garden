...
sidebar_position: 1
title: Capítulo 3
description: CT-TAS - Capítulo 3 - Preparando-se para a Automação de Teste
...
- Cone de Sorvete
	...
	- Defeitos são encontrados tardes no sistema
- Ampulheta
...
O estado final deve ser realista, mesmo que o piramide seja o ideal.
...
Primeiramente necessário é escolher o "o quê" e o "como"
- Após a escolha de:
	- Estratégia
	- Escopo

Então é necessário saber a prioridade do backlog do itens.

- Shift Left
	- mover os testes para mais cedo
- Shift Right
	- entender as preferencias do usuário
...
- Modelo Cascata:
	- Os testes vem depois da implementação,
...
- Critérios:
	...
	- Caso repetível?
	- Fácil de manter quando o SUT atualiza?
	- Abrange fluxo comercial?
	- Sobreposição que permite reutilização de dados?
