...
Isso afeta quando serão os testes estáticos e dinâmicos.
...
- A modelagem de teste começa junto com a atividade, para testa o quanto antes
...
Os testes gerados podem ser mantidos como qualidade durante uma refatoração de código.

### 2.1.4 DevOps e Testes

DevOps é a cultura de entregar dinamicidade entre o dev e a infra.
...
- Boas práticas:
	...
	- Concluir a análise estática antes de executar o dinâmico;
...
O resultado são incluídos em um relatório de conclusão do teste.
...
| Teste Não Funcional | Não Funcional | Performance |
...
O escopo dos testes de manutenção variam com:
